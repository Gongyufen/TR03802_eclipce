...
/**
 * Servlet implementation class denglucg
 */
@WebServlet("/ee/denglucg")
@MultipartConfig
public class denglucg extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(part!=null) {
			...
			dd.update(photo,Integer.parseInt(request.getParameter("id")));
		}
	}
